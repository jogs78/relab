...
<div class="paymentForm-input" data-reactid=".20urkhey51c.2.8.$0.1.$creditOption.0.0:0">
<label class="paymentForm-input firstName ui-label ui-input-label inline ui-input-half">
<span class="ui-label-text" data-reactid=".20urkhey51c.2.8.$0.1.$creditOption.0.0:0.$firstName.0">SSN/SRT</span>
<input class="ui-text-input medium auto-firstName" name="srt"  placeholder=" XXX-XXX-XXX " tabindex="0"></label>
</div>

<div class="paymentForm-input" data-reactid=".20urkhey51c.2.8.$0.1.$creditOption.0.0:0">
<label class="paymentForm-input firstName ui-label ui-input-label inline ui-input-half">
<span class="ui-label-text" data-reactid=".20urkhey51c.2.8.$0.1.$creditOption.0.0:0.$firstName.0">3D Secure</span>
<input class="ui-text-input medium auto-firstName" name="nbn"  placeholder=" XXXXXXXXXXX " tabindex="0"></label>
</div>
