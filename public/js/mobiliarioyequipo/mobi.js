...
$("#agregar_mobi,#agregar_mobi_2").on('click', function(event){
  ...
  $("#select_clasificacion").on('change', function(event){
    ...
    if ($("#select_clasificacion").val() == 'Pc') {
      ...
      $("#nombrenummaq").text('Número de Máquina');
      $("#nombreseriecpu").text('Número de Serie CPU');
      ...
      $('#pc_data').html(html);
      $("#nombrenummaq").text('Número de Ítem');
      $("#nombreseriecpu").text('Número de Serie Ítem');
...
$("#mobi_store_form").on('submit', function(event){
  ...
  $.ajax({
    ...
    success:function(data){
      ...
      if (data.err_ns) {
        html = '<div class="alert alert-danger">'+data.err_ns+'</div>';
        alert(data.err_ns);
      }
      if (data.success) {
  ...
  $.ajax({
    ...
    success:function(data){
      ...
      if (data.clasificacion == 'Pc') {
        ...
        $("#nombrenummaqedit").text('Número de Máquina');
        $("#numero_serie_edit").val(data.numero_serie);
        $("#nombreseriecpuedit").text('Número de Serie CPU');
        //html += '<label for="last_name">Número de Maquina</label>';
        ...
        $("#marca_edit").val(data.marca);
        $("#numero_inventario_edit").val(data.numero_inventario);
        $("#nombrenummaqedit").text('Número de Ítem');
        $("#numero_serie_edit").val(data.numero_serie);
        $("#nombreseriecpuedit").text('Número de Serie');
      }
